...
public class excelManager {
  /**
   * create HabitStorage excel fils
   * 
  ...
  public static void createHabitStorage() throws IOException {
    ...
    // Write the workbook to habit storage file
  ...
  public static void createNewHabit(String HabitName, boolean Repeat_monday,
    ...
    // Write the workbook to a file with the habit name
  ...
  public static void insertNewHabit(String HabitName,
    ...
    // Check whether the provided habit name already exists in the sheet
    for (Row row : sheet) {
  ...
  public static ArrayList<Integer> getOrgonizeData(String habitName) throws IOException {
    ...
    // Counter for number of days not included for this habit
    ...
    // Iterate over each enabled day to count successes and failures
    for (Boolean b : habitEnableDayArrayList) {
      if (b == false) {
        notIncludedDays++;
      }
    }
  ...
  public static Boolean isHabitExisted(String habitName) throws IOException {
    // Open a FileInputStream to read from the "habit_storage.xlsx" file
    FileInputStream file = new FileInputStream("habit_storage.xlsx");
